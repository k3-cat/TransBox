...
### [English](https://github.com/k3-cat/TransBox/wiki/README-(English))

# 安装

点 [-> 这里 <-](https://github.com/k3-cat/TransBox/releases/latest) 然后滚动到页面底部&emsp;再点那个`.apk`结尾的文件就可以下载安装了哦
...
欢迎联系我&emsp;在 [这里](https://github.com/k3-cat/TransBox/wiki/%E8%81%94%E7%B3%BB%E6%88%91%E4%BB%AC-%7C-Contact-Us) 可以找到所有的联系方式

另外 ... 还可以 点一下Star 或者 [投喂我](https://github.com/k3-cat/TransBox/wiki/%E6%8A%95%E5%96%82%E7%8C%AB%E7%8C%AB)
...
另一位的大佬`しず／shizu`做着类似的事&emsp;她写了一篇包含HRT相关方面的原理和常见方案之类的概述 放在 _~~某不存在的~~_ [Google Slides](https://docs.google.com/presentation/d/1PzE-rmtwBMOrgXcsI~~RIDAKTUIe3fx5h-PmEbzRgBBA/edit?usp=sharing) 上
