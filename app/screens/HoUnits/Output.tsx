...
function Output() {
  ...
  if (result === 0) { strResult = `(zero) ${R.ho_units.tUnit}`; }
  else if (result > 10000000) { strResult = `>> 10 000 ${R.ho_units.tUnit}`; }
  else if (result > 10000) { strResult = `> 10 000 ${R.ho_units.tUnit}`; }
  else if (result < 0.000001) { strResult = `<< 0.001 ${R.ho_units.tUnit}`; }
  else if (result < 0.001) { strResult = `< 0.001 ${R.ho_units.tUnit}`; }
  else { strResult = `${result.toFixed(3)} ${R.ho_units.tUnit}`; }
